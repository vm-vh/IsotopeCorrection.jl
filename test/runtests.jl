...
@testset "NaturalIsotopeCorrection.jl" begin
    ...
    corr_response, MID, mean_enrichment, residuum = isotope_correction(response, pyruvate; tracer_purity = 0.99)
    ...
    corr_response, MID, mean_enrichment = isotope_correction(response, pyruvate; tracer_purity = 0.99, optimization = false)
